 ...
 */
@Data
public class CompleteServiceOrderRiskFund implements WxPayScoreExtraParamValidation {
	 ...
	 * 示例值：DEPOSIT
	 * 
	 * @see com.evchong.wxpayscore.api.common.enums.RiskFundExemptFirstEnum
	 * @see com.evchong.wxpayscore.api.common.enums.RiskFundUseFirstEnum
	 */
	@Size(max = 64)
	@NotBlank
	private String name;
